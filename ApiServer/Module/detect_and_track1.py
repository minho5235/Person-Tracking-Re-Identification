...
def detect(save_img=False):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        if db:
            break
        '''if tn and len(im0s) > 0: 
            thumbnail = im0s[0].copy()
            tn = False'''
        # Warmup
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                # Run SORT
                tracked_dets = sort_tracker.update(im0, tracked_people, dets_to_sort)
                ...
                tracked_dets = sort_tracker.update(img, im0)
            #........................................................
